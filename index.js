...
app.get('/forceScrape', async (req, res, next) => {
   ...
   await go('https://www.decathlon.es/es/browse/c0-mujer/c1-calzado-deportivo/c2-zapatillas-deportivas/_/N-lcz36d?Ndrc=5', 'zapatillas_deportivas');
   console.log('Hecho.');
})
...
app.listen(5000, ()=> console.log('El servidor ha iniciado en el puerto 5000'));
...
/* Primer scraping: */
go('https://www.decathlon.es/es/browse/c0-mujer/c1-calzado-deportivo/c2-zapatillas-deportivas/_/N-lcz36d?Ndrc=5', 'zapatillas_deportivas');
go('https://www.decathlon.es/es/browse/c0-mujer/c1-ropa-deportiva/c2-mallas/_/N-1f3scci', 'mallas_mujer');
go('https://www.decathlon.es/es/browse/c0-hombre/c1-calzado-deportivo/c2-nauticos/_/N-1d8q1lr', 'nauticos_hombre');
go('https://www.decathlon.es/es/browse/c0-deportes/c1-ciclismo/_/N-129zvg2', 'tienda_ciclismo');
